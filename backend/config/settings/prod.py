"""
Django settings for DarkWatch Pro — production configuration.
"""
...
TEAM_INVITE_REQUIRE_SMTP_AUTH = os.environ.get('TEAM_INVITE_REQUIRE_SMTP_AUTH', 'True').lower() in ('true', '1', 'yes')
...
# Frontend
FRONTEND_URL = os.environ.get('FRONTEND_URL', 'https://darkwatchpro.com')
